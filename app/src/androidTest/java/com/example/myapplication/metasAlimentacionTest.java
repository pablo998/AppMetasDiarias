...
public class metasAlimentacionTest {
    ...
    public void metasAlimentacionTest() {
        ...
        ViewInteraction tabView = onView(
                allOf(withContentDescription("Bebidas"),
                        childAtPosition(
                                childAtPosition(
        ...
        ViewInteraction tabView4 = onView(
                allOf(withContentDescription("Comidas Diarias"),
                        childAtPosition(
                                childAtPosition(
                                        withId(R.id.tabsMetasPerso),
                                        0),
        ...
        ViewInteraction tabView7 = onView(
                allOf(withContentDescription("Frutas"),
                        childAtPosition(
                                childAtPosition(
                                        withId(R.id.tabsMetasPerso),
                                        0),
