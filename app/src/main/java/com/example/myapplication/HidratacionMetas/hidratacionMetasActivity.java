package com.example.myapplication.HidratacionMetas;
...
import com.example.myapplication.HidratacionMetas.Tab1.Tab1Fragment;
import com.example.myapplication.HidratacionMetas.Tab2.Tab2Fragment;
import com.example.myapplication.HidratacionMetas.Tab3.Tab3Fragment;
...
public class hidratacionMetasActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.metashidratacion);
        setUpBottomAppBar();
        ...
        setSupportActionBar(toolbar);
        tituloLayout.setText(R.string.hidratacionPalabra);
    ...
    private void setupViewPager(ViewPager viewPager) {
        ...
        adapter.addFragment(new Tab2Fragment(),  getResources().getString(R.string.bebidasPalabra));
