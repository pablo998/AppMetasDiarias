package com.example.myapplication.ComidaDiariaMetas;
...
import com.example.myapplication.ComidaDiariaMetas.Tab1.Tab1Fragment;
import com.example.myapplication.ComidaDiariaMetas.Tab2.Tab2Fragment;
import com.example.myapplication.ComidaDiariaMetas.Tab3.Tab3Fragment;
...
public class metasComidasDiariasActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setSupportActionBar(toolbar);
        tituloLayout.setText(R.string.comidaDiaria);
    ...
    private void setupViewPager(ViewPager viewPager) {
        ...
        adapter.addFragment(new Tab2Fragment(),  getResources().getString(R.string.comidasDiariasWords));
