package com.example.myapplication.FrutasMetas;
...
import com.example.myapplication.FrutasMetas.Tab1.Tab1Fragment;
import com.example.myapplication.FrutasMetas.Tab2.Tab2Fragment;
import com.example.myapplication.FrutasMetas.Tab3.Tab3Fragment;
...
public class metasFrutasActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.metasfrutas);
        setUpBottomAppBar();
        ...
        setSupportActionBar(toolbar);
        tituloLayout.setText(R.string.frutasPalabra);
    ...
    private void setupViewPager(ViewPager viewPager) {
        ...
        adapter.addFragment(new Tab2Fragment(),  getResources().getString(R.string.frutasPalabra));
