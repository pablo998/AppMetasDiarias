package com.example.myapplication.CaminarMetas;
...
import com.example.myapplication.CaminarMetas.Tab1.Tab1Fragment;
import com.example.myapplication.CaminarMetas.Tab2.Tab2Fragment;
import com.example.myapplication.CaminarMetas.Tab3.Tab3Fragment;
...
public class metasCaminarActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setSupportActionBar(toolbar);
        tituloLayout.setText(R.string.caminarPalabra);
    ...
    private void setupViewPager(ViewPager viewPager) {
        ...
        adapter.addFragment(new Tab2Fragment(),  getResources().getString(R.string.caminarPalabra));
